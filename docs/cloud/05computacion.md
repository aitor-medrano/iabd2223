...
![Paso 1 - Seleccionar AMI](images/051ami.png)
...
![Paso 2 - Tipo de instancia](images/052tipoinstancia.png)
...
![Paso 3 - Configuración de la instancia](images/053configuracion.png)
...
![Paso 3 - Rol IAM](images/053rol.png)
...
![Paso 3 - Datos de usuario](images/053datosUsuario.png)
...
![Paso 4 - Almacenamiento](images/054datos.png)
...
![Paso 5 - Etiquetas](images/055etiquetas.png)
...
![Paso 6 - Grupo de seguridad](images/056gruposeguridad.png)
...
!!! info "Servidor Web"
    ...
    ![Regla HTTP](images/05reglaHttp.png)
...
![Paso 7 - Resumen](images/057resumen.png)
...
<figure style="align: center;">
    <img src="images/05awsdetails.png">
...
<figure style="align: center;">
    <img src="images/05ciclovida.png">
...
<figure style="align: center;">
    <img src="images/05auripurinuri.png" width="500">
...
<figure style="align: center;">
    <img src="images/05lambda.png" width=600>
...
Nosotros, como desarrolladores, sólo deberemos cargar el código, elegir el tipo de instancia y de base de datos, configurar y ajustar el escalador automático. *Beanstalk* automáticamente administra la implementación, desde el aprovisionamiento de capacidad, el balanceo de carga y el escalado automático hasta la monitorización del estado de las aplicaciones. Al mismo tiempo, si queremos, podemos mantener el control total de los recursos de AWS que alimentan la aplicación y acceder a los recursos subyacentes en cualquier momento.
 ...
 <figure style="align: center;">
    <img src="images/05beanstalk.png" width=600>
