...
4. (RA5075.2 / CE5.2a / 1p) Realiza los casos de uso 1 y 2 de interacción desde *Python* con S3, adjuntando capturas tanto del código *Python* como del bucket en S3.
